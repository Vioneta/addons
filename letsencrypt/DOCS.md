# Vioneta Agro Add-on: Letsencrypt
...
Navigate in your Vioneta Agro frontend to the add-ons overview page at
...
- Doesn’t need you to open a port to your Vioneta Agro host on your router.
...
Vioneta Agro in the default paths, add the following lines to Home
...
renewal via [Vioneta Agro automation][haauto], and then restarting this
automation every night via the [Supervisor Addon restart action][supervisorrestart].

[haauto]: https://www.vioneta.com/docs/automation/editor/
[supervisorrestart]: https://www.vioneta.com/integrations/hassio/#service-hassioaddon_restart
...
mode (default), and configure DNS, simply copy the attributes underneath _dns_
into the _DNS Provider configuration_ field.
...
on the Vioneta Agro host before starting the service. One way is to use the
...
Please copy your credentials file "google.json" into the "share" shared folder on the Vioneta Agro host before starting the service.

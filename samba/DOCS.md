# Vioneta Agro Add-on: Samba share
...
1. In the configuration section, set a username and password.
   You can specify any username and password; these are not related in any way to the login credentials you use to log in to Vioneta Agro or to log in to the computer with which you will use Samba share.
...
| `config`        | This is for your Vioneta Agro configuration.                           |
| `media`         | This is for local media files.                                         |
| `share`         | This is for your data that is shared between add-ons and Vioneta Agro. |

...
SUPERVISOR_VERSON="$(curl -s https://raw.githubusercontent.com/Vioneta/version/refs/heads/master/dev.json | jq -e -r '.supervisor')"
DOCKER_TIMEOUT=30
DOCKER_PID=0
...
function run_supervisor() {
    ...
    docker run --rm --privileged \
        ...
        "vioneta/amd64-hassio-supervisor:${SUPERVISOR_VERSON}"
}

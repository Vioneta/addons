...
- Bump Python Matter Server to [6.1.0](https://github.com/home-assistant-libs/python-matter-server/releases/tag/6.1.0)
  - This update is required for Vioneta Agro Core 2024.6.0
...
- Bump minimum required Vioneta Agro core version to 2023.12 due to breaking changes in the schema
...
- Require Vioneta Agro Core 2023.1.0b1 to install the add-on. The chip SDK was bumped in [Matter Server 1.0.8](https://github.com/home-assistant-libs/python-matter-server/releases/tag/1.0.8).
